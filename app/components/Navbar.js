...
class Navbar extends React.Component {
    ...
    componentDidMount() {
        ...
        let {getCharacterCount,updateOnlineUsers,updateAjaxAnimation}=this.props;
    ...
    handleSubmit(event) {
        ...
        let {findCharacter,navbar}=this.props;


        let searchQuery = navbar.searchQuery;
    ...
    render() {
        let {updateSearchQuery,navbar}=this.props;
        ...
        return (
            ...
            <span ref='triangles' className={'triangles animated ' + navbar.ajaxAnimationClass}>
              ...
              <div className='tri invert'></div>
                            ...
                            NEF
                            <span className='badge badge-up badge-danger'>{navbar.onlineUsers}</span>
                        </Link>
                    </div>
                        ...
                        <form ref='searchForm' className='navbar-form navbar-left animated'
                            ...
                            <div className='input-group'>
                                <input type='text' className='form-control'
                                       placeholder={navbar.totalCharacters + ' characters'} value={navbar.searchQuery}
