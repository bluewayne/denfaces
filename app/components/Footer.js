...
class Footer extends React.Component {
    ...
    componentDidMount() {
        ...
        let {getTopCharacters,characters}=this.props;
        getTopCharacters();
    ...
    render() {
        let { getTopCharacters, getTopCharactersSuccess, getTopCharactersFail, characters } = this.props;

        let leaderboardCharacters = characters.map((character) => {
            return (
